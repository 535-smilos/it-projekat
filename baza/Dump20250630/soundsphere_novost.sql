...
CREATE TABLE `novost` (
  `id_novost` int NOT NULL AUTO_INCREMENT,
  `naslov` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `opis` text,
...
INSERT INTO `novost` VALUES (1,'Pripreme za Euroviziju 2025','Takmicari Crne Gore se pripremaju za Evroviziiju 2025');
